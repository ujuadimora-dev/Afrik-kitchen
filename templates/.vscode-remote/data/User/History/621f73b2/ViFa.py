...
from django.urls import path
from afrik_kitchen.views import contact, contact_success
...
urlpatterns = [
   ...
   # path('event/', include('event.urls', namespace='event')),
    ...
    # path('contact_success/', success, name='contact_success'),
    path('contact/', contact, name='contact'),
    path('contact_success/<str:name>/', success, name='contact_success'),
