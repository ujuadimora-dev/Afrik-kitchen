...
from .views import BookingList, TableListView, TableDetailView, BookingCreateView, BookingSuccessView, CancelBoookingView
from . import views
...
urlpatterns = [
   ...
   # path('managebookings/', ManageBooking.as_view(), name='managebookings'),
    ...
    path('booking/cancel/pk>/', CancelBoookingView.as_view(), name='CancelBoookingView'),
#     