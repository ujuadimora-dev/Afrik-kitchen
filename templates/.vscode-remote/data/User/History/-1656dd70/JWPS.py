...
class Booking(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, max_length=100, default=get_default_username)
    customer_name = models.CharField(max_length=100)
 ...
 models.CharField(max_length=100, default=get_default_username)
