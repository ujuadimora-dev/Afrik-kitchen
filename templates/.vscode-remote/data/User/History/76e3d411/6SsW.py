...
class Table(models.Model):
   ...
   #number = models.IntegerField(default=0)
    ...
    def __str__(self):
        return f'{self.table_number} **is** {self.status} ***position** {self.table_position} **for** {self.capacity} number_of_guests'
...
class Booking(models.Model):
    ...
    reservation_time = models.CharField(max_length=20, choices=BOOKING_TIME, default="mon")
