...
class EditBookingView(UpdateView):
    model = Booking
    fields =  ['capacity', 'table_position', 'reservation_date', 'reservation_time']  # Specify the fields to be edited
    template_name = 'booking_edit.html'  # Replace with your desired template name
    success_url = reverse_lazy('booking:managebookings')  # Redirect to the booking list page
