...
class CancelBookingView(DeleteView):
    def get(self, request, booking_id):
        ...
        try:
            ...
            return redirect('404.html')  # Example: redirect to a "booking not found" page

        # Perform the necessary operations to cancel the booking
        # For example, you might delete the booking from the database
        booking.delete()

        # Redirect to a success page or any other desired page
        return redirect('booking:booking_cancel_view')  # Example: redirect to a "booking cancelled" page
