...
class BookingView(FormView):
    ...
    def form_valid(self, form):
        ...
        if avaliable_tables:
            ...
            reservation_time_label = dict(Booking.BOOKING_TIME).get(data['reservation_time'], '')

            # Pass the customer name, reservation time, and other booking details to the success template
            context = {
                'customer_name': customer_name,
                ...
                'wheelchair_accessibility': table.wheelchair_accessible,
            }
